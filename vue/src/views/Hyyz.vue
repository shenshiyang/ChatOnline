      ...
      <el-table border :data="tableData" style="width: 100%">
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button type="success" plain @click="handleUpdateZt(scope.row,'1')" v-if="scope.row.zt === '0'">通过</el-button>
            <el-button type="danger" plain @click="handleUpdateZt(scope.row,'2')" v-if="scope.row.zt === '0'">拒绝</el-button>
